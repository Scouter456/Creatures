...
public class MVBlocks {
    ...
    public static final RegistryObject<Block> mucus                      = BLOCKS.register("mucus", () -> new MVMucusBlock(MucusVariant.mucus, AbstractBlock.Properties.create(Material.CLAY).hardnessAndResistance(3.0F, 10.0F).sound(SoundType.SLIME).notSolid().harvestLevel(2).harvestTool(ToolType.SHOVEL).setRequiresTool().tickRandomly()));
